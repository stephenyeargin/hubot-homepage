...
const script = require('../../src/homepage');
...
async function createTestBot() {
  ...
  // httpd: true so run() sets up express/router for route registration
  const robot = new Robot(path.resolve(__dirname, 'adapter'), true, 'hubot');
